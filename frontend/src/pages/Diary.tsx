...
import { Search, Plus, Trash2, Utensils, X, Flame, Beef, Wheat, Droplet } from 'lucide-react'
import { api, FoodSearchResult, Meal } from '../lib/api'
          ...
          <>
            <div className="p-4 border-b border-slate-100">
              <div className="relative">
                ...
                <input
                  autoFocus
                  placeholder='Buscar en OpenFoodFacts (ej. "huevo", "pan", "yogur")…'
                  value={query}
              ...
              {searchQ.data?.map((food, i) => (
                ...
                >
                  ...
                  <div className="text-xs text-slate-500 mt-1">
                    {food.kcal_per_100g} kcal/100g · P{food.protein_per_100g} / C{food.carbs_per_100g} / G{food.fat_per_100g}
                  </div>
                </button>
              ))}
            </div>
